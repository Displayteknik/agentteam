      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1.25rem" }}>
            <Link
              href="/docs"
              style={{ fontSize: "0.85rem", color: "#6b7280", textDecoration: "none", display: "flex", alignItems: "center", gap: "0.35rem", transition: "color 0.15s" }}
            ...
            <a
              ...
              style={{ fontSize: "0.85rem", color: "#6b7280", textDecoration: "none", display: "flex", alignItems: "center", gap: "0.4rem", transition: "color 0.15s" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "#ffffff")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "#6b7280")}
            >
              Tillbaka till sidan
